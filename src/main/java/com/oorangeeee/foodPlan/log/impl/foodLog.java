...
public class foodLog implements log {
    ...
    // 日志文件路径
    private final String logPath = "./log/foodLog.txt";
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof foodLog foodLogObj) {
            return this.infoCounts == foodLogObj.infoCounts &&
                    this.errorCounts == foodLogObj.errorCounts &&
                    this.panicCounts == foodLogObj.panicCounts;
        }
        return false;
    }
