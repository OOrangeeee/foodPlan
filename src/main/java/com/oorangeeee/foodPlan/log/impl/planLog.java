...
/**
 * 这个类实现了日志记录接口 log，用于计划相关日志的记录和管理。
...
public class planLog implements log {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof planLog planLogObj) {
            return this.infoCounts == planLogObj.infoCounts &&
                    this.errorCounts == planLogObj.errorCounts &&
                    this.panicCounts == planLogObj.panicCounts;
        }
        return false;
    }
